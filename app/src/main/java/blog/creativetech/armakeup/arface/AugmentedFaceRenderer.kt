...
public class AugmentedFaceRenderer {
    ...
    private var textureUniformDudak = 0
    ...
    private var tintColorDudakUniform = 0
    private var tintColorDudak = floatArrayOf(1.0f, 1.0f, 1.0f, 0f)
    ...
    private val textureId = IntArray(3)
    ...
    fun createOnGlThread(
        ...
        textureUniformDudak = GLES20.glGetUniformLocation(program, "u_TextureDudak")
        ...
        tintColorDudakUniform = GLES20.glGetUniformLocation(program, "u_TintColorDudak")
        ...
        loadTexture(context, textureId, diffuseTextureAssetNames[2], 2)
    }
    ...
    fun draw(
        ...
        GLES20.glActiveTexture(GLES20.GL_TEXTURE2)
        GLES20.glUniform1i(textureUniformDudak, 2)
        ...
        GLES20.glUniform4fv(tintColorDudakUniform, 1, tintColorDudak, 0)
    ...
    fun setDudakColor(dudakColor: FloatArray) {
        tintColorDudak = dudakColor
    }
